          ...
          <div className="flex gap-8 py-20  items-center justify-center flex-col">
            <div className="flex gap-4 flex-col">
              ...
              <p className="text-lg p-2 md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center">
                Strengthen your leadership mindset with coaching focused on
                vision, influence, emotional intelligence, and strategic
                thinking. Designed for emerging and experienced leaders aiming
                to inspire teams and drive meaningful change.
              </p>
            </div>
