...
const course = {
  ...
  description:
    'Learn to build responsive, dynamic, and user-friendly websites and applications using modern technologies and frameworks.',
};
...
const callouts = [
  {
    ...
    imageSrc:
      'https://images.unsplash.com/photo-1618477388954-7852f32655ec?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fHdlYiUyMGRldmVsb3BtZW50fGVufDB8fDB8fHww',
    imageAlt: 'Web Development Courses Pictures',
    description: 'Understand HTML, CSS, JavaScript, and web design principles.',
    mainPageDesc:
      'This course introduces learners to the core concepts of web development, focusing on how websites are designed, structured, and built. Participants learn HTML, CSS, and JavaScript fundamentals while gaining an understanding of responsive design and user experience. The course emphasizes hands-on practice through building simple, functional web pages. Learners also explore version control, web hosting, and the basics of frameworks and libraries. By the end, participants acquire the foundational skills needed to begin their journey as front-end or full-stack developers, capable of creating modern, interactive, and user-friendly websites.',
    highlights: [
      'Create interactive, visually appealing user interfaces.',
      'Manage databases, servers, and application logic.',
      'Combine frontend and backend for complete web solutions.',
      'Work with tools like React, Node.js, and Tailwind CSS.',
    ],
