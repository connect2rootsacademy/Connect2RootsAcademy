...
export const CoursesCard = ({
  ...
  return (
    <section
      className={cn('container relative my-20 py-10 mx-auto px-4', className)}
    >
      {/* Title */}
      <h1 className="mb-30 text-4xl text-center font-bold text-black sm:text-5xl lg:text-6xl">
