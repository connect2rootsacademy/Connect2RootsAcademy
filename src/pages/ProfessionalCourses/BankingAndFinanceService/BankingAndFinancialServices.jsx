...
const course = {
  ...
  description:
    'Equip yourself with the financial expertise and analytical skills demanded by banks, investment firms, and global financial',
};

const callouts = [
  {
    name: 'Banking & Financial Services',
    title: 'Foundations of Banking & Financial Services',
    imageSrc:
      'https://plus.unsplash.com/premium_photo-1681748777410-71e6510de13d?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDV8fGJhbmtpbmd8ZW58MHx8MHx8fDA%3D',
    imageAlt: 'Business and Finacial Services Courses Pictures',
    description:
      'This course provides a comprehensive introduction to the banking and financial services industry.',
    mainPageDesc:
      'This course provides a comprehensive understanding of the banking and financial ecosystem. Learners explore the fundamentals of banking operations, financial markets, investment principles, and regulatory frameworks. Through real-world examples and case studies, participants gain insight into how banks, NBFCs, and financial institutions function. The program also focuses on digital banking trends, financial inclusion, and customer relationship management. By the end, learners develop essential analytical and practical skills required to build a strong foundation for a successful career in banking, finance, or related domains, preparing them for industry certifications and professional growth opportunities.',
    highlights: [
      'Understand the fundamentals of banking and finance.',
      'Learn about financial markets and institutions.',
      'Gain insights into investment and risk management.',
      'Develop skills for a career in the financial sector.',
    ],
