...
const course = {
  ...
  description:
    'Explore intelligent systems and data-driven solutions to analyze trends, automate tasks, and drive smarter business decisions.',
};
...
const callouts = [
  {
    ...
    imageSrc:
      'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fG1hY2hpbmUlMjBsZWFybmluZ3xlbnwwfHwwfHx8MA%3D%3D',
    imageAlt: 'AI & Data Science Courses Pictures',
    description:
      'Learn basics of machine learning, data analysis, and predictive modeling.',
    mainPageDesc:
      'This course introduces the core principles of Artificial Intelligence and Data Science, focusing on how machines learn from data to make intelligent decisions. Learners explore key concepts such as supervised and unsupervised learning, data processing, predictive modeling, and basic algorithms. Practical exercises using real-world datasets help participants understand the application of AI across industries. The course also highlights ethical AI practices and the role of data-driven decision-making in business and technology. By the end, learners gain foundational knowledge and skills to pursue advanced learning in machine learning, AI development, and analytics.',
    highlights: [
      'Understand algorithms that enable systems to learn and improve automatically.',
      'Learn to interpret complex datasets for informed decision-making.',
      'Explore how AI simulates human intelligence for automation and innovation.',
      'Develop models to forecast trends and optimize business strategies.',
    ],
            ...
            <div>
              <div class="mx-auto max-w-4xl text-center">
                <p class="mt-20 text-7xl leading-19 font-extrabold tracking-tight text-balance text-black sm:text-8xl">
                  <span className="text-green-600">AI</span> and Data Science
                </p>
              </div>
