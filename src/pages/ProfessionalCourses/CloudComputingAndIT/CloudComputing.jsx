...
const course = {
  ...
  description:
    'Learn how cloud technologies and IT systems transform businesses through scalability, security, and efficient digital operations.',
};

const callouts = [
  {
    name: 'Cloud Computing & IT',
    title: 'Foundations of Cloud Computing and IT',
    imageSrc:
      'https://images.unsplash.com/photo-1600267147646-33cf514b5f3e?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fGNsb3VkJTIwY29tcHV0aW5nfGVufDB8fDB8fHww',
    imageAlt: 'Cloud Computing and IT Courses Pictures',
    description:
      'Understand basic cloud models, data storage, and IT infrastructure concepts.',
    mainPageDesc:
      'This course introduces learners to the fundamental concepts of cloud computing and modern IT infrastructure. Participants explore cloud models (IaaS, PaaS, SaaS), virtualization, data storage, and security frameworks. The program explains how cloud technologies are transforming industries by enabling scalability, flexibility, and cost efficiency. Hands-on modules help learners understand deployment models like AWS, Azure, and Google Cloud. Additionally, the course covers networking basics, IT systems management, and emerging technologies in the digital space. By completion, learners gain a strong foundation to pursue careers in cloud solutions, IT support, or system administration.',
    highlights: [
      'Explore AWS, Azure, and Google Cloud fundamentals.',
      'Learn secure data storage, backup, and access solutions.',
      'Understand networks, servers, and system management essentials.',
      'Gain awareness of data protection and cloud security practices.',
    ],
            ...
            <div>
              <div class="mx-auto max-w-4xl text-center">
                <p class="mt-20 text-7xl leading-19 font-extrabold tracking-tight text-balance text-black sm:text-8xl">
                  <span className="text-green-600">Cloud</span> Computing and IT
                </p>
              </div>
