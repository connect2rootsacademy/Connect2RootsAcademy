          ...
          <div className="flex gap-8 py-20  items-center justify-center flex-col">
            <div className="flex gap-4 flex-col">
              ...
              <p className="text-lg p-2 md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center">
                Get dedicated support to overcome challenges, set clear goals,
                and build confidence in your personal and professional journey.
                Individual coaching helps you unlock potential through focused,
