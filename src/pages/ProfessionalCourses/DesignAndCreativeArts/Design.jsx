...
const course = {
  ...
  description:
    'Discover the art of visual storytelling, innovation, and creativity through design principles, aesthetics, and modern digital tools.',
};

const callouts = [
  {
    name: 'Design & Creative Arts',
    title: 'Foundations of Design and Creative Arts',
    imageSrc:
      'https://images.unsplash.com/photo-1587440871875-191322ee64b0?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHVpdXh8ZW58MHx8MHx8fDA%3D',
    imageAlt: 'Design and Creative Arts Courses Pictures',
    description:
      'Learn the basics of color, composition, and creative expression.',
    mainPageDesc:
      'This course empowers learners to explore creativity through the lens of design, art, and digital expression. It covers the principles of visual design, color theory, composition, and branding while introducing modern tools used in creative industries. Learners engage in practical projects to develop skills in graphic design, illustration, and visual storytelling. The program encourages innovation, conceptual thinking, and aesthetic sensitivity — essential for careers in design, advertising, and digital media. By the end, participants gain a creative edge and the technical proficiency to bring their artistic visions to life.',
    highlights: [
      'Understand layout, color theory, and typography for impactful designs.',
      'Develop innovative ideas and artistic problem-solving skills.',
      'Learn software like Photoshop, Illustrator, and Figma.',
      'Explore various mediums to convey messages visually and emotionally.',
    ],
            ...
            <div>
              <div class="mx-auto max-w-4xl text-center">
                <p class="mt-20 font-extrabold tracking-tight text-balance text-black text-5xl sm:text-8xl sm:leading-19">
                  <span className="text-green-600">Design</span> and Creative
                  Arts
                </p>
              </div>
